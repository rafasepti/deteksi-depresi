...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm" aria-current="page">Data Gejala</li>
        ...
        <div class="card-body px-5 pb-2">
            <form method="POST" action="{{ route('admin.gejala.store') }}">
                ...
                <div class="input-group input-group-outline my-3 is-filled">
                  ...
                  <input type="text" class="form-control" required name="kode_gejala" id="kode_gejala" readonly value="{{ $kode }}">
                </div>
                <div class="input-group input-group-outline my-3">
                  <label class="form-label">Nama Gejala</label>
                  <input type="text" class="form-control" required name="nama_gejala" id="nama_gejala">
                </div>
                <div class="input-group input-group-outline my-3 is-filled">
